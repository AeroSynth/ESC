...
sosHP = signal.butter(LPorder, HPcutoff, 'hp', fs=RATE, output='sos')
sosLP = signal.butter(LPorder, LPcutoff, 'lp', fs=RATE, output='sos')
#sosBP = signal.butter(LPorder, BPcutoff, 'bp', fs=RATE, output='sos')
